...
def loadData(opts, cuda):
    ...
    test_loader, inp_shape_2 = data_ada.test_loader(input, target_byte, attack_window, batch_size, trace_num, shifted, leakage_model, kwargs)
    #test_loader, inp_shape = data_ada.loader(input, target_byte, attack_window, batch_size, trace_num, shifted, leakage_model, kwargs)
    inp_shape_2=(1,1000)
    print(inp_shape_2)
    return test_loader, inp_shape_2
